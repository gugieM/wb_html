...
<div id="container" class="grid">
   ...
   <div id="search_area" class="col_12 column">
    ...
    <div id="category block" class="col_12 column">
			<h3>Browse Jobs</h3>
			<ul>
				<li><a href="jobs.html?category=1">Artisans</a></li>
				<li><a href="jobs.html?category=1">Carpentry</a></li>
				<li><a href="jobs.html?category=1">Child Minding</a></li>
				<li><a href="jobs.html?category=1">Construction</a></li>
				<li><a href="jobs.html?category=1">Domestics</a></li>
				<li><a href="jobs.html?category=1">Electrical</a></li>
				<li><a href="jobs.html?category=1">General Maintanance</a></li>
				<li><a href="jobs.html?category=1">Handy Man</a></li>
				<li><a href="jobs.html?category=1">Landscaping & Gardening</a></li>
				<li><a href="jobs.html?category=1">Painting</a></li>
				<li><a href="jobs.html?category=1">Plumbing</a></li>
				<li><a href="jobs.html?category=1">Tree Felling</a></li>
				<li><a href="jobs.html?category=1">Tutoring</a></li>
				<li><a href="jobs.html?category=1">Other</a></li>
		</ul>
	</div>
			 ...
			 <div class="col_12 column">
				 ...
				 <ul id="Listings">
					 ...
					 <div class="description">
						 <h5>Painter Wanted (Johannesburg, Gauteng)</h5>
						 Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt
						 ut laoreet dolore magna aliquam erat volutpat.<a href="details.html"> <i class="icon-plus"></i> Read More</a>
					 </div>
				 </li>
